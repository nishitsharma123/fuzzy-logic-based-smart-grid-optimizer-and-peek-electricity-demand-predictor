  ...
  return (
    <div className="flex flex-col">
      <div className="w-5/6 m-auto h-[500px] flex flex-row">
        <div>
          <h1 className="text-6xl font-bold p-5 mt-32">
            Grid Optimizer <br />& real time analysis
          </h1>
          <p className="pl-5 w-[900px]">
            Our product provides real-time electricity peak demand analysis
            through interactive charts. By leveraging advanced forecasting
            models, it helps businesses and energy providers monitor, predict,
            and optimize energy consumption trends efficiently.
          </p>
        ...
        <div>
          <video
            ...
            autoPlay
            src={video1}
            className="mt-32 h-[400px] w-96 object-cover rounded-3xl"
          ></video>
        </div>
      </div>
      {showDashboard ? (
